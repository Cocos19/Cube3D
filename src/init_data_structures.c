...
/*   Updated: 2023/12/11 09:41:18 by angassin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../cub3d.h"

static void		init_player(t_display *display);
static void		init_bonus_textures_and_colors(t_display *display);
static t_img	*init_sprite(t_display *display, char *path);

/*
	display is the main data structure in the program, it contains:
	...
	allow only one parameter to be passed to the hook functions
*/
...
/*
	parses the file given in argument and setup all the variables
